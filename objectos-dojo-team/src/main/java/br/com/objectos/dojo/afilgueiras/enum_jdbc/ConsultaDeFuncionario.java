...
public class ConsultaDeFuncionario {
  ...
  public List<Funcionario> list() {
    ...
    lista.add(new Funcionario(Departamento.ENGENHARIA));
    lista.add(new Funcionario(Departamento.FINANCEIRO));
    lista.add(new Funcionario(Departamento.CONTABILIDADE));
    return lista;
  }
